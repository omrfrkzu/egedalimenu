...
function StaffApp({ variant = 'admin' }) {
  ...
  const requiredRole = variant === 'admin' ? 'admin' : 'garson'
  const shouldShowLogin = !currentUser || currentUser.role !== requiredRole
  const LoginComponent = variant === 'admin' ? AdminLogin : WaiterLogin
